  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <Link
          to="/"
          className="flex items-center justify-center space-x-2 mb-6 sm:mb-8"
        >
          ...
          <span className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">GigWave</span>
        </Link>

        {/* Card */}
        <div className="bg-white dark:bg-emerald-900/50 rounded-2xl border border-gray-200 dark:border-emerald-700/40 p-6 sm:p-8 shadow-xl">
          <h2 className="text-center text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-2">
            Sign in to GigWave
          </h2>
